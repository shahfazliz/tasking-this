...
}, action32 = async ({ request, params }) => (await erase2({ id: params.id }), (0, import_node40.redirect)("/users"));
...
var action34 = async ({ request, params }) => {
