...
var loader3 = async ({ request, params }) => {
  ...
  return console.log(color), (await search4({ id: params.id }))[0].set({
    name,
    color,
    description,
    updatedBy: user
